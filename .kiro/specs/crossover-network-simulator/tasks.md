...
### 5. Utility Functions
- [ ] 5.1 Implement generateUniqueId() function for component IDs
- [ ] 5.2 Implement parseEngineering() for engineering notation parsing (4.7k, 10u, 100n)
- [ ] 5.3 Implement formatEngineering() for engineering notation formatting
- [ ] 5.4 Implement E12/E24 standard value stepping functions
- [ ] 5.5 Write unit tests for engineering notation parsing edge cases
- [ ] 5.6 Write property test: Engineering notation parsing round-trip (Property 9)
- [ ] 5.7 Write property test: Parameter validation rejects invalid values (Property 10)

## Phase 3: File I/O and Data Import

### 6. File Operations
- [ ] 6.1 Implement file save functionality with schema validation
- [ ] 6.2 Implement file load functionality with schema validation and error handling
- [ ] 6.3 Implement unsaved changes tracking (dirty flag)
- [ ] 6.4 Implement recent files list management
- [ ] 6.5 Write unit tests for file save/load with valid and invalid files
- [ ] 6.6 Write property test: Invalid file rejection (Property 19)
- [ ] 6.7 Write property test: Unsaved changes tracking (Property 20)

### 7. FRD/ZMA File Parsing
- [ ] 7.1 Implement FrdParser class for parsing frequency response files
- [ ] 7.2 Implement ZmaParser class for parsing impedance files
- [ ] 7.3 Implement monotonic frequency validation
- [ ] 7.4 Implement FRD/ZMA export functionality
- [ ] 7.5 Write unit tests for FRD/ZMA parsing with valid and invalid files
- [ ] 7.6 Write property test: FRD/ZMA parsing produces monotonic frequencies (Property 21)
- [ ] 7.7 Write property test: Invalid data error reporting (Property 22)

### 8. DXO File Import
- [ ] 8.1 Research XSim .dxo file format structure
- [ ] 8.2 Implement DxoImporter class for parsing .dxo files
- [ ] 8.3 Implement component mapping from DXO to internal format
- [ ] 8.4 Implement connection mapping from DXO to internal Wire format
- [ ] 8.5 Write unit tests for DXO import with reference files
- [ ] 8.6 Handle unsupported DXO features with warnings

## Phase 4: Circuit Editor UI

### 9. Canvas Rendering
- [ ] 9.1 Create CircuitEditor.vue component with HTML5 Canvas
- [ ] 9.2 Implement grid dot rendering with configurable spacing
- [ ] 9.3 Implement component rendering for all component types
- [ ] 9.4 Implement wire rendering with multi-segment support
- [ ] 9.5 Implement annotation text rendering
- [ ] 9.6 Implement selection highlighting
- [ ] 9.7 Write unit tests for coordinate transformations
- [ ] 9.8 Write property test: Grid snapping invariant (Property 5)

### 10. Mouse Interaction
- [ ] 10.1 Implement mouse event handlers (mousedown, mousemove, mouseup)
- [ ] 10.2 Implement component selection on click
- [ ] 10.3 Implement component drag-and-drop from palette
- [ ] 10.4 Implement component move mode with grid snapping
- [ ] 10.5 Implement wire creation by dragging between terminals
- [ ] 10.6 Implement multi-segment wire routing
- [ ] 10.7 Implement scroll/pan functionality
- [ ] 10.8 Write unit tests for hit detection and selection
- [ ] 10.9 Write property test: Wire connectivity invariant (Property 3)
- [ ] 10.10 Write property test: Multi-segment wire validity (Property 6)

### 11. Zoom and View Controls
- [ ] 11.1 Implement zoom in/out buttons
- [ ] 11.2 Implement zoom percentage input field
- [ ] 11.3 Implement zoom transformation for canvas rendering
- [ ] 11.4 Implement scroll area expansion logic
- [ ] 11.5 Write unit tests for zoom calculations
- [ ] 11.6 Verify grid snapping works at all zoom levels

### 12. Component Palette
- [ ] 12.1 Create ComponentPalette.vue component
- [ ] 12.2 Implement component icons (SVG or image assets)
- [ ] 12.3 Implement drag-and-drop from palette to canvas
- [ ] 12.4 Implement component creation on drop
- [ ] 12.5 Write unit tests for palette interactions

### 13. Context Menu and Keyboard Shortcuts
- [ ] 13.1 Implement right-click context menu for components
- [ ] 13.2 Implement context menu items: Tune, Delete, Rotate, Invert, Mute
- [ ] 13.3 Implement keyboard shortcuts: Delete, T (tune), Spacebar (rotate), Escape
- [ ] 13.4 Implement context menu for wires (Delete)
- [ ] 13.5 Write unit tests for keyboard event handling
- [ ] 13.6 Write property test: Component rotation preserves connections (Property 24)

### 14. Undo/Redo System
- [ ] 14.1 Implement undo stack in Vuex store
- [ ] 14.2 Implement redo stack in Vuex store
- [ ] 14.3 Implement action recording for all editing operations
- [ ] 14.4 Implement undo/redo keyboard shortcuts (Ctrl+Z, Ctrl+Y)
- [ ] 14.5 Write unit tests for undo/redo operations
- [ ] 14.6 Write property test: Undo/redo inverse operations (Property 2)

## Phase 5: Component Parameter Dialogs

### 15. Tune Dialog Component
- [ ] 15.1 Create TuneDialog.vue component with modal overlay
- [ ] 15.2 Implement passive component parameter inputs (value, tolerance, ESR, state)
- [ ] 15.3 Implement speaker parameter inputs (name, sensitivity, delay, invert, mute)
- [ ] 15.4 Implement voltage source parameter inputs (power, impedance, delay, invert)
- [ ] 15.5 Implement file selection buttons for FRD/ZMA files
- [ ] 15.6 Implement phase source radio buttons (measured/derived)
- [ ] 15.7 Implement off-axis file management UI
- [ ] 15.8 Implement up/down increment buttons with E12/E24 stepping
- [ ] 15.9 Implement engineering notation input parsing
- [ ] 15.10 Write unit tests for parameter validation
- [ ] 15.11 Write property test: Default parameter assignment (Property 8)
