...
- [ ] 1. Schema definition and OpAmp model
  - [x] 1.1 Add OpAmp type and parameter definitions to circuit.schema.json
  ...
  - [x] 1.2 Create src/models/OpAmp.js extending Component
  ...
  - [x] 1.3 Register OpAmp in Circuit.js deserialization and Component validTypes
  ...
  - [x] 1.4 Add OpAmp to VCVS handling in CircuitSolver.js
  ...
  - [x] 1.5 Checkpoint — lint and verify schema + model + solver integration
    - Run `npm run lint` and fix any errors
    - Run `npm test` to ensure no existing tests are broken
    - Ensure all tests pass, ask the user if questions arise.

- [ ] 2. OpAmp unit tests and property-based tests
  - [x] 2.1 Create tests/unit/OpAmp.spec.js with unit tests
  ...
  - [x] 2.2 Write property test for OpAmp serialization round-trip
  ...
  - [x] 2.3 Write property test for OpAmp validation correctness
  ...
  - [x] 2.4 Write property test for transfer function formula correctness
  ...
  - [x] 2.5 Write property test for DC gain magnitude
  ...
  - [x] 2.6 Write property test for corner frequency -3 dB point
  ...
  - [x] 2.7 Write property test for high-frequency roll-off rate
  ...
  - [x] 2.8 Write property test for circuit-level serialization round-trip
  ...
  - [x] 2.9 Checkpoint — lint and verify all OpAmp tests
    - Run `npm run lint` and fix any errors
    - Run `npm test` to ensure all tests pass
    - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Integration tests and solver verification
  - [x] 3.1 Create tests/unit/OpAmp-integration.spec.js
  ...
  - [x] 3.2 Checkpoint — lint and verify integration tests
    - Run `npm run lint` and fix any errors
    - Run `npm test` to ensure all tests pass
    - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. UI: OpAmp canvas rendering, palette, and shared label logic
  - [x] 4.1 Add OpAmp rendering to CircuitEditor.vue
  ...
  - [x] 4.3 Add OpAmp to ComponentPalette.vue
...
- [ ] 5. UI: OpAmp Tune Dialog and final verification
  - [x] 5.1 Add OpAmp Configuration section to TuneDialog.vue
  ...
  - [x] 5.2 Final checkpoint — full lint and test suite
    - Run `npm run lint` and fix any errors
